...
@synthesize bgImage,bgBarImage,txtMessage;
@synthesize btnBack;
...
- (void)viewDidLoad
{
    ...
    txtMessage=[[UITextView alloc]initWithFrame:CGRectMake(10, 115, 290, 365)];		
...
-(void)infoSendAndGetFromWeb
{
    ...
    NSMutableURLRequest *req =[[ NSMutableURLRequest alloc ] initWithURL: 
                               [ NSURL URLWithString:@"http://www.sunraysiahearing.com.au/feeds/about.php?"]]; 
