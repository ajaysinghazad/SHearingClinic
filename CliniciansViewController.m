...
@implementation CliniciansViewController

@synthesize bgImage,bgBarImage,tblCliniciansView;
@synthesize btnBack;
...
-(void)handleTimer
{
    ...
    [self.view addSubview:tblCliniciansView];
...
- (void)viewDidLoad
{
    ...
    tblCliniciansView=[[UITableView alloc]initWithFrame:CGRectMake(0,90,320,333 )style:UITableViewStylePlain];
    tblCliniciansView.backgroundColor=[UIColor clearColor];
    
    tblCliniciansView.delegate=self;
    tblCliniciansView.dataSource=self;
...
-(void)infoSendAndGetFromWeb
{
    ...
    NSMutableURLRequest *req =[[ NSMutableURLRequest alloc ] initWithURL: 
                               [ NSURL URLWithString:@"http://www.sunraysiahearing.com.au/feeds/clinicians.php?"]]; 
...
{	
	...
	if (indexPath.row==0)
	{
        ...
        lblName.text=[[arrayFromWebServiceParse objectAtIndex:indexPath.row] objectForKey:@"title="];//[[arrayFromWebServiceParse objectAtIndex:indexPath.row] objectForKey:@"title="];
        
		[cell.contentView addSubview:lblName];
        
		UILabel *lblDegree=[[UILabel alloc]initWithFrame:CGRectMake(90, 50, 230, 10)];
        ...
        UILabel *lblContent=[[UILabel alloc]initWithFrame:CGRectMake(90, 65, 230, 30)];
        ...
        lblContent.text=[[arrayFromWebServiceParse objectAtIndex:indexPath.row] objectForKey:@"content="];
        ...
        
    {
        ...
        lblName.text=[[arrayFromWebServiceParse objectAtIndex:indexPath.row] objectForKey:@"title="];//[[arrayFromWebServiceParse objectAtIndex:indexPath.row] objectForKey:@"title="];
         ...
         UILabel *lblDegree=[[UILabel alloc]initWithFrame:CGRectMake(90, 30, 230, 10)];
        lblDegree.backgroundColor=[UIColor clearColor];
        lblDegree.textColor=[UIColor whiteColor];
        lblDegree.font=[UIFont boldSystemFontOfSize:10.0];
        lblDegree.textAlignment=UITextAlignmentLeft;
        ...
        UILabel *lblContent=[[UILabel alloc]initWithFrame:CGRectMake(90, 45, 230, 30)];
        lblContent.backgroundColor=[UIColor clearColor];
        [lblContent setNumberOfLines:2];
        lblContent.textColor=[UIColor whiteColor];
        lblContent.font=[UIFont boldSystemFontOfSize:12.0];
